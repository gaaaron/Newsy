...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Newsy.Domain.Entities.ContainsTag", b =>
                {
                    b.HasBaseType("Newsy.Domain.Entities.Tag");

                    b.Property<string>("TextToMatch")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasDiscriminator().HasValue("ContainsTag");
                });
